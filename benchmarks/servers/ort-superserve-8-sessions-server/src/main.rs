//! Benchmark server using ort-superserve library with 8 sessions.
//!
//! Same as ort-superserve-server but with 8 sessions instead of 1
//! to demonstrate scaling with multiple ONNX sessions.
...
async fn main() -> Result<()> {
    ...
    println!("ort-superserve-8-sessions-server listening on http://0.0.0.0:3006");
